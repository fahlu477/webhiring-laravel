...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Data Experience</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
                <h1 class="box-title"><i class="fa fa-list-ul"></i> List Data Experience</h1>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <table id="user_table" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>Name</th>
                                <th>Minimum Experience of Year</th>
                                <th>Maximum Experience of Year</th>
            ...
            <div class="box-footer">
                <a href="{{ route('admin.experience.create') }}" type="button" class="btn btn-primary btn-flat">Add Data Experience</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#user_table').DataTable({
                ...
                serverSide  : true,
                search      : true,
                ajax: '{!! route('admin.experience.data_table') !!}',
                columns: [
                    { data: null, "orderable": false, "targets": 0 },
                    { data: 'name', name: 'name' },
                    { data: 'minimum_experience_of_year', name: 'minimum_experience_of_year' },
                    { data: 'maximum_experience_of_year', name: 'maximum_experience_of_year' },
